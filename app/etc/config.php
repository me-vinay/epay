...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'ClassyLlama_LlamaCoin' => 1,
        'Cminds_Supplierfrontendproductuploader' => 1,
        'Cminds_Marketplacebilling' => 1,
        'Cminds_Marketplace' => 1,
        'CustomModule_Myjs' => 1,
        'CustomModule_Regform' => 1,
        'Epay_Humanitarian' => 1,
        'Klarna_Core' => 1,
        ...
        'Mvn_Cam' => 1,
        'Mymodule_Customshipping' => 1,
        'Mymodule_DeveloperTest' => 1,
        'Mymodule_MinQunatityNotificationEmail' => 0,
        'Mymodule_OfflinePayment' => 1,
        'Mymodule_Testcron' => 1,
        'Mymodule_Webhook' => 1,
        'Mymodule_myCustomGraphql' => 1,
        'Neosoft_Core' => 1,
        'Neosoft_Logistics' => 1,
        'Neosoft_Nettelo' => 1,
        'Smartwave_Core' => 1,
