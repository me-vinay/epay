...
namespace Cminds\Marketplacebilling\Block\Catalog\Product\Supplier;
...
use Cminds\Marketplacebilling\Block\Catalog\Product\Supplier;

/**
 * Class Name
 *
 * @package Cminds\Marketplacebilling\Block\Catalog\Product\Supplier
 */
class Name extends Supplier
{
    ...
    {
        $this->setTemplate('marketplacebilling/catalog/product/supplier/name.phtml');
    }
    ...
    public function isSupplierHasProfile()
    {
        ...
        if (!$this->scopeConfig->getValue('configuration_marketplacebilling/configure/enable_supplier_pages')) {
            return false;
        }
