...
namespace Cminds\Marketplacebilling\Helper;
...
class Data extends DataParent
{
    ...
    public function shippingMethodsEnabled()
    {
        return (bool)$this->scopeConfig->getValue(
            'configuration_marketplacebilling/configure/allow_supplier_manage_shipping_costs'
        );
    }
    ...
    public function getStatusesCanSee()
    {
        return explode(
            ...
            $this->scopeConfig->getValue(
                'configuration_marketplacebilling/'
                . 'presentation/'
    ...
    {
        return $this->scopeConfig->getValue(
            'configuration_marketplacebilling/presentation/additional_attributes',
            'store',
            $store
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'configuration_marketplacebilling/presentation/invoice_guest_template',
            'store'
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'configuration_marketplacebilling/presentation/invoice_template',
            'store'
        );
    }
    ...
    {
        return $this->scopeConfig->getValue(
            'configuration_marketplacebilling/presentation/add_sold_by_option_on_product_page',
            'store'
        );
    }
