...
use Cminds\Marketplacebilling\Model\Fields;
use Cminds\Marketplacebilling\Model\Supplier\Notification;
...
{
    const NOTIFY_SUPPLIER_CONFIG_PATH = "configuration_marketplacebilling/configure/notify_supplier_when_his_profile_was_approved";
